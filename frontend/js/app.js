...
async function showDetailMode(boxId) {
    try {
        ...
        document.getElementById('display-label').textContent = boxData.label;
            ...
            const items = typeof boxData.content === 'string' ? JSON.parse(boxData.content) : boxData.content;
            ...
            items.forEach((item, index) => {
                ...
                checkbox.addEventListener('change', () => toggleItemChecked(boxId, index, checkbox.checked));
                ...
                span.addEventListener('click', () => enableEditMode(boxId, index, span));
                
                const deleteBtn = document.createElement('button');
                deleteBtn.textContent = 'Hapus';
                deleteBtn.className = 'delete-btn';
                deleteBtn.addEventListener('click', () => deleteItem(boxId, index));
...
document.addEventListener('DOMContentLoaded', function() {
    // Periksa apakah ada hash di URL saat pertama kali dibuka
